...
namespace GameLib.Dbg
{
    ...
    public class DebugLayoutB : MonoBehaviour
    {
        ...
        private void PrepareLayouts()
        {
            foreach (Transform screenTransform in transform)
            {
                ...
                foreach (Transform frameTransform in screenTransform)
                {
                    ...
                    Dictionary<Direction2D.RelativeDirection, float> stackPointers =
                        new Dictionary<Direction2D.RelativeDirection, float>();
                    ...
                    Dictionary<Direction2D.RelativeDirection, float> poleSize =
                        new Dictionary<Direction2D.RelativeDirection, float>();
                    ...
                    foreach (var debugLayoutElement in elements)
                    {
                        ...
                        SetAnchors(newElementTransform, stackPointer, elementSizeNormalized, gapSizeNormalized,
                            debugLayoutElement.Side);
        ...
        private void SetAnchors(RectTransform rectTransform, float stackPointer, Vector2 elementSizeNormalized,
            Vector2 gapSizeNormalized, Direction2D.RelativeDirection side)
        {
            switch (side)
            {
                // move down:
                ...
                case Direction2D.RelativeDirection.Right:
                    rectTransform.anchorMin =
                        new Vector2(1f - gapSizeNormalized.x - elementSizeNormalized.x, stackPointer);
                    break;
                ...
                case Direction2D.RelativeDirection.RightDown:
                    rectTransform.anchorMin = new Vector2(1f - gapSizeNormalized.x - elementSizeNormalized.x,
                        stackPointer - elementSizeNormalized.y);
                    break;
                ...
                case Direction2D.RelativeDirection.Up:
                    rectTransform.anchorMin = new Vector2(stackPointer - elementSizeNormalized.x,
                        1f - gapSizeNormalized.y - elementSizeNormalized.y);
                    break;
        ...
        private float GetInitialStackPointer(Direction2D.RelativeDirection side,
            Dictionary<Direction2D.RelativeDirection, float> poleSize)
        {
            switch (side)
            {
        ...
        private float MoveStackPointer(float pointer, Direction2D.RelativeDirection side, Vector2 elementSizeNormalized,
            Vector2 gapSizeNormalized)
        {
            switch (side)
            {
                // move down:
